...
<div class="row">
  <div class="col-xs-12">
    <ol class="comment_list_ol">
      ...
      ?>
      <li class="decmt-box">
        <p><a href="#addcomment" rel="nofollow">请输入密码再查看评论内容.</a></p>
      </li>
      <?php
      ...
      ?>
      <li class="decmt-box">
        <p><a href="#addcomment" rel="nofollow">还没有任何评论，你来说两句吧</a></p>
      </li>
      <?php
        } else {
    ...
    ?>
    <p>你必须 <a href="<?php echo wp_login_url( get_permalink() ); ?>" rel="nofollow">登录</a> 才能发表评论.</p>
    <?php else  : ?>
</div>
<hr class="mtb">
<div class="row">
